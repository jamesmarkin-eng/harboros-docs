...
description: "See how you're tracking against plan — and which line items, New or Renewal, drove the gap."
...
- A [snapshot comparison](/workflows/snapshots) is one date vs another — *what moved since last time?*
